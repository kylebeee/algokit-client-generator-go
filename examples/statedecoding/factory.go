...
// Factory is a typed factory for deploying StateDecoding smart contracts.
type Factory struct {
...
// Create deploys a new instance of the StateDecoding contract.
...
// Deploy performs an idempotent deployment of the StateDecoding contract.
