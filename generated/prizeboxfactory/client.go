...
// Client is a typed client for the PrizeBoxFactory smart contract.
type Client struct {
...
func (c *Client) SendMint(ctx context.Context, params algokit.CallParams[MintArgs]) (*MintMethodResult, error) {
